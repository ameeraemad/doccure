        ...
        <div class="card-body pt-0">
            ...
            <nav class="user-tabs mb-4">
                <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#pat_prescriptions" data-toggle="tab">الوصفات الطبية</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#pat_medical_records" data-toggle="tab"><span
                                class="med-records">السجلات الطبية</span></a>
                    </li>
                    <li class="nav-item">
                                                ...
                                                <h2 class="table-avatar">
                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                        <img class="avatar-img rounded-circle"
                                                            src="{{asset('doccure/assets/img/doctors/doctor-thumb-01.jpg')}}"
                                                            alt="User Image">
                                                    </a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                        <img class="avatar-img rounded-circle"
                                                            src="{{asset('doccure/assets/img/doctors/doctor-thumb-03.jpg')}}"
                                                            alt="User Image">
                                                    </a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                        <img class="avatar-img rounded-circle"
                                                            src="{{asset('doccure/assets/img/doctors/doctor-thumb-04.jpg')}}"
                                                            alt="User Image">
                                                    </a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                        <img class="avatar-img rounded-circle"
                                                            src="{{asset('doccure/assets/img/doctors/doctor-thumb-05.jpg')}}"
                                                            alt="User Image">
                                                    </a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                        <img class="avatar-img rounded-circle"
                                                            src="{{asset('doccure/assets/img/doctors/doctor-thumb-06.jpg')}}"
                                                            alt="User Image">
                                                    </a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                        <img class="avatar-img rounded-circle"
                                                            src="{{asset('doccure/assets/img/doctors/doctor-thumb-07.jpg')}}"
                                                            alt="User Image">
                                                    </a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                        <img class="avatar-img rounded-circle"
                                                            src="{{asset('doccure/assets/img/doctors/doctor-thumb-08.jpg')}}"
                                                            alt="User Image">
                                                    </a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                        <img class="avatar-img rounded-circle"
                                                            src="{{asset('doccure/assets/img/doctors/doctor-thumb-09.jpg')}}"
                                                            alt="User Image">
                                                    </a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                        <img class="avatar-img rounded-circle"
                                                            src="{{asset('doccure/assets/img/doctors/doctor-thumb-10.jpg')}}"
                                                            alt="User Image">
                                                    </a>

...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{asset('doccure/assets/plugins/bootstrap-rtl/css/bootstrap.min.css')}}">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12 col-12">
                        <nav aria-label="breadcrumb" class="page-breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active">لوحة تحكم الاطباء</li>
                                <li class="breadcrumb-item active" aria-current="page">الرئيسية</li>
                            </ol>
                        </nav>
                        <h2 class="breadcrumb-title">الرئيسية</h2>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="widget-profile pro-widget-content">
                                <div class="profile-info-widget">
                                    ...
                                    <div class="profile-det-info">
                                        <h3>{{ Auth::user('doctor')->full_name }}</h3>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{route('doctor.social-media')}}">
                                                ...
                                                <span>حسابات السوشيال ميديال</span>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="{{route('cms.logout',['doctor'])}}">

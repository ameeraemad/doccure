    ...
    <div class="col-md-7 col-lg-8 col-xl-9">
        <div class="appointments">
            ...
            <div class="appointment-list">
                <div class="profile-info-widget">
                    <a href="patient-profile.html" class="booking-doc-img">
                        <img src="{{asset('doccure/assets/img/patients/patient1.jpg')}}" alt="User Image">
                    </a>
                    <div class="profile-det-info">
            ...
            <div class="appointment-list">
                <div class="profile-info-widget">
                    <a href="patient-profile.html" class="booking-doc-img">
                        <img src="{{asset('doccure/assets/img/patients/patient2.jpg')}}" alt="User Image">
                    </a>
                    <div class="profile-det-info">
            ...
            <div class="appointment-list">
                <div class="profile-info-widget">
                    <a href="patient-profile.html" class="booking-doc-img">
                        <img src="{{asset('doccure/assets/img/patients/patient3.jpg')}}" alt="User Image">
                    </a>
                    <div class="profile-det-info">
            ...
            <div class="appointment-list">
                <div class="profile-info-widget">
                    <a href="patient-profile.html" class="booking-doc-img">
                        <img src="{{asset('doccure/assets/img/patients/patient4.jpg')}}" alt="User Image">
                    </a>
                    <div class="profile-det-info">
            ...
            <div class="appointment-list">
                <div class="profile-info-widget">
                    <a href="patient-profile.html" class="booking-doc-img">
                        <img src="{{asset('doccure/assets/img/patients/patient5.jpg')}}" alt="User Image">
                    </a>
                    <div class="profile-det-info">
            ...
            <div class="appointment-list">
                <div class="profile-info-widget">
                    <a href="patient-profile.html" class="booking-doc-img">
                        <img src="{{asset('doccure/assets/img/patients/patient6.jpg')}}" alt="User Image">
                    </a>
                    <div class="profile-det-info">
            ...
            <div class="appointment-list">
                <div class="profile-info-widget">
                    <a href="patient-profile.html" class="booking-doc-img">
                        <img src="{{asset('doccure/assets/img/patients/patient7.jpg')}}" alt="User Image">
                    </a>
                    <div class="profile-det-info">
            ...
            <div class="appointment-list">
                <div class="profile-info-widget">
                    <a href="patient-profile.html" class="booking-doc-img">
                        <img src="{{asset('doccure/assets/img/patients/patient8.jpg')}}" alt="User Image">
                    </a>
                    <div class="profile-det-info">
            ...
            <div class="appointment-list">
                <div class="profile-info-widget">
                    <a href="patient-profile.html" class="booking-doc-img">
                        <img src="{{asset('doccure/assets/img/patients/patient9.jpg')}}" alt="User Image">
                    </a>
                    <div class="profile-det-info">
            ...
            <div class="appointment-list">
                <div class="profile-info-widget">
                    <a href="patient-profile.html" class="booking-doc-img">
                        <img src="{{asset('doccure/assets/img/patients/patient10.jpg')}}" alt="User Image">
                    </a>
                    <div class="profile-det-info">
            ...
            <div class="appointment-list">
                <div class="profile-info-widget">
                    <a href="patient-profile.html" class="booking-doc-img">
                        <img src="{{asset('doccure/assets/img/patients/patient11.jpg')}}" alt="User Image">
                    </a>
                    <div class="profile-det-info">

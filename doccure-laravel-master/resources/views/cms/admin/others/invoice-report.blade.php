...
@section('page-breadcrumb','Invoice Report')
                            ...
                            <tr>
                                ...
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img
                                                class="avatar-img rounded-circle"
                                                src="{{asset('doccure/admin/assets/img/patients/patient6.jpg')}}"
                                                alt="User Image"></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img
                                                class="avatar-img rounded-circle"
                                                src="{{asset('doccure/admin/assets/img/patients/patient7.jpg')}}"
                                                alt="User Image"></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img
                                                class="avatar-img rounded-circle"
                                                src="{{asset('doccure/admin/assets/img/patients/patient8.jpg')}}"
                                                alt="User Image"></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img
                                                class="avatar-img rounded-circle"
                                                src="{{asset('doccure/admin/assets/img/patients/patient9.jpg')}}"
                                                alt="User Image"></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img
                                                class="avatar-img rounded-circle"
                                                src="{{asset('doccure/admin/assets/img/patients/patient10.jpg')}}"
                                                alt="User Image"></a>

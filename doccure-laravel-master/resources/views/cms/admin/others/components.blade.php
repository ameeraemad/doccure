            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="avatar avatar-xxl">
                                <img class="avatar-img rounded-circle" alt="User Image" src="{{asset('doccure/admin/assets/img/profiles/avatar-02.jpg')}}">
                            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="avatar">
                                <img class="avatar-img rounded" alt="User Image" src="{{asset('doccure/admin/assets/img/profiles/avatar-02.jpg')}}">
                            </div>
                            <div class="avatar">
                                <img class="avatar-img rounded-circle" alt="User Image" src="{{asset('doccure/admin/assets/img/profiles/avatar-02.jpg')}}">
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="avatar-group">
                                <div class="avatar">
                                    <img class="avatar-img rounded-circle border border-white" alt="User Image" src="{{asset('doccure/admin/assets/img/profiles/avatar-02.jpg')}}">
                                </div>
                                <div class="avatar">
                                    <img class="avatar-img rounded-circle border border-white" alt="User Image" src="{{asset('doccure/admin/assets/img/profiles/avatar-03.jpg')}}">
                                </div>
                                <div class="avatar">
                                    <img class="avatar-img rounded-circle border border-white" alt="User Image" src="{{asset('doccure/admin/assets/img/profiles/avatar-04.jpg')}}">
                                </div>
                                <div class="avatar">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4 d-flex">
                    <div class="card flex-fill">
                        <img alt="Card Image" src="{{asset('doccure/admin/assets/img/img-01.jpg')}}" class="card-img-top">
                        <div class="card-header">

            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row custom_price_cont" id="custom_price_cont" style="display: none;">
                        <div class="col-md-4">
                            <input type="text" class="form-control" id="per_hour" name="custom_rating_count" value="0"
                                placeholder="20">
...
<script src="{{asset('doccure/assets/plugins/bootstrap-tagsinput/js/bootstrap-tagsinput.js')}}">
</script>
...
<script>
    function performStore(){
        console.log("PRICING: "+document.getElementById('price_free').checked)
        var data = {
